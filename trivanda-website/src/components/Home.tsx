...
const Home: React.FC = () => {
  ...
  return (
    <div className="home">
      ...
      {/* About Block */}
      <section className={`about-block ${aboutIntersecting ? 'animate-in' : ''}`} ref={aboutRef}>
        <div className="container">
          <h2 className={`about-title ${aboutIntersecting ? 'title-animate' : ''}`}>Who We Are</h2>
          <p className={`about-description ${aboutIntersecting ? 'description-animate' : ''}`}>
            Trivanda Internationals is a government-registered Indian export company dedicated to delivering high-quality, value-driven products worldwide. With a vision to empower Indian manufacturing on a global platform, we specialize in Tutti Frutti, Paper Dishes, and other FMCG goods.
          </p>
          <div className={`about-credentials ${aboutIntersecting ? 'credentials-animate' : ''}`}>
            <span className="credentials-label">Registered Under:</span>
            <div className="badges-container">
              <span className="badge badge-animate" style={{ '--delay': '0.1s' } as React.CSSProperties}>IEC</span>
              <span className="badge badge-animate" style={{ '--delay': '0.2s' } as React.CSSProperties}>GST</span>
              <span className="badge badge-animate" style={{ '--delay': '0.3s' } as React.CSSProperties}>MSME</span>
              <span className="badge badge-animate" style={{ '--delay': '0.4s' } as React.CSSProperties}>RCMC-APEDA-SEPC</span>
            </div>
          </div>
        </div>
        {/* Animated background elements */}
